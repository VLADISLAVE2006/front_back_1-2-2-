...
function Admin({ user }) {
    ...
    const handleEdit = (product) => {
        ...
        setPreviewImage(product.image ? `http://localhost:3000${product.image}` : null);
        setShowForm(true);
    };
    ...
    const handleDelete = async (id) => {
        ...
        try {
            ...
            showNotification(
                error.response?.data?.error || 'Ошибка удаления. Возможно, у вас недостаточно прав.',
                'error'
            );
        }
    };
    ...
    return (
        <div className="container">
            ...
            <section className="admin-panel">
                ...
                {showForm && (user?.role === 'seller' || user?.role === 'admin') && (
