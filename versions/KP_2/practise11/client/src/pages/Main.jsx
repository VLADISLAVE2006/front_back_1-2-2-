...
function Main() {
    ...
    const fetchProducts = async () => {
        try {
            ...
            console.log('Товары загружены:', response.data); // Добавим лог
                    ...
                    {filteredProducts.map(product => (
                        <div key={product.id} className="product-card">
                            ...
                            <img 
                                ...
                                onError={(e) => {
                                    console.log('Ошибка загрузки картинки:', product.image);
                                    e.target.src = 'http://localhost:3001/uploads/placeholder-default.jpg';
